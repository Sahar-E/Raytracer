...
//    __host__ __device__ explicit World(const ArrayOfObjects &objects) : _objects(objects) {}

//    __host__ __device__ void copyObjectList(Sphere *arrayOfObjects, size_t nSpheres) {
//        if () {}
//    }
